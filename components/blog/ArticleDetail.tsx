    ...
    <div className="pf-container pb-24 pt-10 md:pb-32 md:pt-14">
      ...
      >
        <div className={hasHeroImage ? "max-w-3xl" : "max-w-4xl"}>
          ...
          <p className="mt-5 flex flex-wrap items-center gap-x-3 gap-y-1 text-sm text-pf-muted">
          ...
          <p className="pf-prose mt-8 text-lg leading-relaxed text-pf-ink-soft md:text-xl">
