...
export const faqs: FAQItem[] = [
  ...
  {
    question:
      "¿Podéis hacer la landing page si tengo el negocio fuera de España?",
    answer:
      "Sí. Trabajamos en remoto con negocios de cualquier país de habla hispana. El proceso es 100% digital y solo necesitamos una persona de decisión disponible durante el proyecto.",
  },
  {
    question: "¿Necesito tener el contenido listo antes de empezar?",
    answer:
      "No es necesario tenerlo todo listo. Para comenzar el diseño web necesitamos tu oferta principal, público objetivo y objetivo de conversión. El copy y los textos los trabajamos contigo durante el proceso.",
  },
  {
    question: "¿Una landing page mejora el posicionamiento en Google?",
    answer:
      "Una landing page bien estructurada mejora el SEO técnico: velocidad de carga, estructura de encabezados, datos estructurados y experiencia de usuario. No sustituye a una estrategia de contenidos, pero es una base sólida para posicionar búsquedas transaccionales de alto valor.",
  },
];
